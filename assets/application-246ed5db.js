...
// app/javascript/controllers/books/image_picker_controller.js
var image_picker_controller_default = class extends Controller {
  ...
  showSelectedImage(selectedRadio = null) {
    const radioButtons = this.element.querySelectorAll('input[type="radio"]');
    const selected = selectedRadio || this.element.querySelector('input[type="radio"]:checked');
    ...
    if (selected) {
      ...
      selected.closest(".js-wrapper").getElementsByClassName("js-checkmark")[0].classList.remove("hidden");
      radioButtons.forEach((radio) => {
        if (radio !== selected) {
...
// app/javascript/controllers/chapters/text_controller.js
var text_controller_default = class extends Controller {
...
// app/javascript/controllers/shared/character_counter_controller.js
...
// app/javascript/controllers/shared/cleanup_controller.js
var cleanup_controller_default = class extends Controller {
  remove() {
    this.element.remove();
  }
};

// app/javascript/controllers/shared/clipboard_controller.js
...
// app/javascript/controllers/shared/confirmation_controller.js
...
// app/javascript/controllers/shared/darkmode_controller.js
var darkmode_controller_default = class extends Controller {
  connect() {
...
// ../../shared/node_modules/stimulus-use/dist/index.js
...
// app/javascript/controllers/shared/dropdown_controller.js
...
// app/javascript/controllers/shared/infinite_scroll_controller.js
...
// ../../shared/node_modules/el-transition/index.js
...
// app/javascript/controllers/shared/radio_selector_controller.js
var radio_selector_controller_default = class extends Controller {
  ...
  updateDisplay() {
    ...
    if (currentButton) {
      this.labelTarget.textContent = currentButton.querySelector("label").textContent;
    }
    ...
    this.element.closest("form").querySelectorAll(".js-credit-cost").forEach((element) => {
    ...
    if (currentUserCredits >= creditsCost) {
      this.element.closest("form").querySelector(".js-submit").classList.remove("hidden");
      this.element.closest("form").querySelector(".js-buy-credits").classList.add("hidden");
    } else {
      this.element.closest("form").querySelector(".js-submit").classList.add("hidden");
      this.element.closest("form").querySelector(".js-buy-credits").classList.remove("hidden");
    }
  }
  previous() {
    this.index = (this.index - 1 + this.radioTargets.length) % this.radioTargets.length;
...
// app/javascript/controllers/shared/remote_submit_controller.js
var remote_submit_controller_default = class extends Controller {
  connect() {
    this.loadingText = this.element.getAttribute("data-loading-text") || "Loading...";
...
// app/javascript/controllers/shared/slideshow_controller.js
...
application.register("books--image-picker", image_picker_controller_default);
application.register("chapters--text", text_controller_default);
application.register("shared--character-counter", character_counter_controller_default);
application.register("shared--cleanup", cleanup_controller_default);
application.register("shared--clipboard", clipboard_controller_default);
application.register("shared--confirmation", confirmation_controller_default);
application.register("shared--darkmode", darkmode_controller_default);
application.register("shared--dropdown", dropdown_controller_default);
application.register("shared--infinite-scroll", infinite_scroll_controller_default);
application.register("shared--modal", modal_controller_default);
application.register("shared--radio-selector", radio_selector_controller_default);
application.register("shared--remote-submit", remote_submit_controller_default);
application.register("shared--slideshow", slideshow_controller_default);
...
@hotwired/turbo/dist/turbo.es2017-esm.js:
   ...
   *)
*/
//# sourceMappingURL=/assets/application-7c78b25c.js.map
